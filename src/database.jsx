...
/**
 * 🔥 Update user score & time in Firestore leaderboard.
 */
// export const updateLeaderboard = async (uid, score, time) => {
//   try {
//     console.log(`📌 Updating leaderboard for UID: ${uid}`);
...
/**
 * 🔥 Update user profile in Firestore (`user` collection) & sync to `leaderboard`.
 */
